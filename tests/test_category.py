...
@patch("main.create_category", new_callable=AsyncMock)
...
@patch("main.get_all_categories", new_callable=AsyncMock)
...
@patch("main.get_category_by_name", new_callable=AsyncMock)
...
@patch("main.delete_category", new_callable=AsyncMock)
