...
@patch("db.supabase.register_user", new_callable=AsyncMock)
...
@patch("db.supabase.login_user", new_callable=AsyncMock)
...
@patch("db.supabase.get_user_by_email", new_callable=AsyncMock)
@patch("db.supabase.login_user", new_callable=AsyncMock)
@patch("db.supabase.register_user", new_callable=AsyncMock)
def test_get_user_by_email(mock_register_user, mock_login_user, mock_get_user_by_email):
    mock_register_user.return_value = {"id": "123", "email": "testuser@example.com"}
    mock_login_user.return_value = {"access_token": "fake_token"}
    mock_get_user_by_email.return_value = {"id": "123", "email": "testuser@example.com"}
...
@patch("db.supabase.delete_user", new_callable=AsyncMock)
@patch("db.supabase.login_user", new_callable=AsyncMock)
